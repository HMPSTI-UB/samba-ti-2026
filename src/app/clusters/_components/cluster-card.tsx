...
export default function ClusterCard({ cluster }: { cluster: PublicCluster }) {
  return (
    <div className="group relative flex h-full flex-col overflow-hidden rounded-2xl border border-[#B95C00]/25 bg-gradient-to-b from-[#3A1E0F] to-[#241007] p-6 transition-all duration-300 hover:-translate-y-1 hover:border-[#B95C00]/50 hover:shadow-[0_12px_32px_rgba(185,92,0,0.18)]">
